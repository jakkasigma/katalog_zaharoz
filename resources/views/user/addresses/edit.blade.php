<x-store-layout title="Edit Alamat">
    <section class="pt-14 pb-16 bg-black min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">

            <div class="mb-12">
                <p class="font-mono text-xs uppercase tracking-[0.3em] text-rose-400 mb-4">Edit Alamat</p>
                <h1 class="font-display text-5xl uppercase text-white leading-none mb-6">
                    Perbarui<br><span class="text-rose-500">Alamat</span>
                </h1>
