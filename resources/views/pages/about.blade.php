...
{{-- Page Header --}}
    <section class="pt-32 pb-16 bg-black border-b border-zinc-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="font-display text-5xl sm:text-6xl uppercase text-white">Tentang Kami</h1>
    ...
    <section class="py-24 bg-black">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                <div>
                    <p class="font-mono text-xs uppercase tracking-[0.3em] text-zinc-600 mb-6">Kisah Kami</p>
                    <h2 class="font-display text-3xl sm:text-4xl uppercase text-white mb-6">Lahir dari Penolakan</h2>
                ...
                {{-- Timeline / milestones --}}
                <div class="space-y-0">
                    <p class="font-mono text-xs uppercase tracking-[0.3em] text-zinc-600 mb-8">Perjalanan</p>
                    @php
                        $milestones = [
                    ...
                    @foreach ($milestones as $m)
                        <div class="flex gap-6 pb-8 relative">
                            <div class="flex flex-col items-center">
                                <div class="w-2 h-2 bg-rose-500 rotate-45 shrink-0 mt-1.5"></div>
                            ...
                            <div class="pb-2">
                                ...
                                <p class="text-sm text-zinc-500">{{ $m['desc'] }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
    ...
    <section class="py-24 bg-zinc-950 border-t border-zinc-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="font-display text-4xl uppercase text-white">Yang Kami Percaya</h2>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-px bg-zinc-800">
                ...
                @foreach ($values as $v)
                    <div class="bg-black p-10">
                        <div class="w-8 h-px bg-rose-600 mb-6"></div>
                        <h3 class="font-cinzel text-sm uppercase tracking-[0.2em] text-white mb-4">{{ $v['title'] }}</h3>
    ...
    <section class="py-24 bg-black border-t border-zinc-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 class="font-display text-4xl uppercase text-white mb-4">Di Balik Layar</h2>
            <p class="text-zinc-500 max-w-xl mx-auto mb-12">
                Kami adalah kelompok kecil yang percaya bahwa pakaian bisa menjadi seni, bukan industri.
            </p>
            <a href="{{ route('contact') }}"
               class="inline-flex items-center gap-2 font-cinzel text-xs uppercase tracking-[0.2em] px-8 py-4 border border-zinc-700 hover:border-rose-600 text-zinc-400 hover:text-rose-400 transition-colors duration-200">
                Hubungi Kami
            </a>
        </div>
    </section>
