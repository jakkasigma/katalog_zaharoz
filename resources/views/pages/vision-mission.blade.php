<x-layout title="Visi & Misi">
    ...
    <section class="bg-black border-b border-zinc-900" style="padding-top: 96px; padding-bottom: 40px;">
        <div class="max-w-7xl mx-auto px-4 sm:px-8">
            ...
            <h1 class="font-display text-4xl sm:text-6xl uppercase text-white">Visi & Misi</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                ...
                <div class="lg:col-span-4">
                    ...
                    <h2 class="font-display text-3xl sm:text-4xl lg:text-5xl uppercase text-white leading-tight">Visi</h2>
                </div>

                <div class="lg:col-span-8 border-l-2 border-zinc-800 pl-6 sm:pl-10">
                    <blockquote class="font-cinzel text-base sm:text-xl text-zinc-200 leading-relaxed mb-6 sm:mb-8 uppercase tracking-wide">
    ...
    {{-- Mission --}}
    <section class="py-16 sm:py-24 bg-zinc-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">

                <div class="lg:col-span-4">
                    <p class="font-mono text-xs uppercase tracking-[0.3em] text-rose-400 mb-3">02</p>
                    <h2 class="font-display text-3xl sm:text-4xl lg:text-5xl uppercase text-white leading-tight">Misi</h2>
                </div>

                <div class="lg:col-span-8">
                    <p class="text-sm text-zinc-400 mb-8 sm:mb-10 leading-relaxed">
                    ...
                    <div class="space-y-px">
                        ...
                        @foreach ($missions as $m)
                            <div class="group flex gap-4 sm:gap-6 bg-black hover:bg-zinc-950 border border-zinc-900 p-5 sm:p-6 transition-colors duration-200">
    ...
    {{-- Closing statement --}}
    <section class="py-16 sm:py-24 bg-black border-t border-zinc-900 text-center">
        <div class="max-w-3xl mx-auto px-4 sm:px-8">
            <div class="flex items-center justify-center gap-4 mb-8 sm:mb-12">
                <div class="h-px w-10 sm:w-12 bg-zinc-800"></div>
                <div class="w-1.5 h-1.5 bg-rose-600 rotate-45"></div>
                <div class="h-px w-10 sm:w-12 bg-zinc-800"></div>
            </div>
            <p class="font-cinzel text-base sm:text-lg lg:text-xl uppercase tracking-[0.2em] text-zinc-300 leading-relaxed mb-8 sm:mb-10">
                Kami tidak membuat pakaian untuk semua orang.<br class="hidden sm:block">Kami membuat pakaian untuk mereka yang tepat.
            </p>
            <a href="{{ route('contact') }}"
               class="inline-flex items-center justify-center gap-2 w-full sm:w-auto font-cinzel text-xs uppercase tracking-[0.2em] px-8 py-4 bg-rose-600 hover:bg-rose-500 text-white transition-colors duration-200 min-h-[44px]">
